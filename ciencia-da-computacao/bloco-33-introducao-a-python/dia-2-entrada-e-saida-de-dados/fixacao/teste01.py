...
# O desempacotamento de valores é um recurso muito útil de Python quando queremos
# separar os valores recebidos em variáveis diferentes.
# Quando há uma atribuição múltipla e o valor da direita pode ser percorrido,
# o Python entende que deve atribuir cada um dos valores a uma variável da esquerda, seguindo a ordem.
